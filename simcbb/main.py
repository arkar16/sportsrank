...
#FIXME slate is broken
single_week_calc(YEAR, WEEK, END_WEEK, DIVISION, HFA, BASE_CORS, timestamp)  # FIXME printing no d1 games but there are for week-by-week calculations
...
# FIXME nc and wt not writing correctly
