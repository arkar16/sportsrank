...
def html_grab(start_year, end_year, division):
    ...
    title_html += "</body>\n"
    title_html += "</html>\n"
    html_nc = f'<a href="cfb/years/history/nc_{division}_CFB">Link to all {division} CFB National Champions</a><br>\n' # TODO CFB to {SPORT}
    html_wt = f'<a href="cfb/years/history/wt_{division}_CFB">Link to all {division} CFB Worst Teams</a><br>\n' # TODO CFB to {SPORT}
