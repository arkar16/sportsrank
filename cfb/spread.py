...
def weekly_spread(year, week, division, week_cors, hfa, timestamp, snapshot_service=None):
    ...
    if snapshot_service is None:
        ...
        week_slate = get_week_slate(YEAR, WEEK, DIVISION, timestamp, snapshot_service)
    ...
    os.chdir(config.owd)
    # Empty slates render an empty table; all unexpected failures propagate.
